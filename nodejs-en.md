...
> For transferring large amounts of data, use Worker Threads. IPC has limitations with very large data transfers and may cause errors when exceeding buffer capacity (~200 MB).
