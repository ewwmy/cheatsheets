...
# копируем все файлы приложения (при этом некоторые файлы и папки, например, node_modules с хост-компьютера, следует исключить из копирования, указав их в .dockerignore)
COPY . .
