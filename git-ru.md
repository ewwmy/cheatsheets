...
git commit --amend -m "Комментарий для коммита" # добавить изменения в последний коммит и заменить его сообщение на новое (обычно используется для редактирования сообщения последнего коммита)
git commit --amend --no-edit # добавить изменения в последний коммит без изменения его сообщения
```
